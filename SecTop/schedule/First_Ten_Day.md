...
|----| ----------------------- | --------------------- | ---------------------|--------------|------------------------------------------------------------------------------------------------------------------------------------------- | 
|SMB-001| Legacy               | Samba Overview        |  ***Published***           |  Oct 26      |   [Secure File Sharing for Mixed Environments](https://github.com/richard-sebos/articles/blob/main/CUPS-Samba/SMB-001/2025-10-26-Samba.md) |
|SMB-002| Legacy               | Samba Global          |  ***Published***       |  Nov 2       |   [Securing Samba at the Global Level](https://richard-sebos.github.io/sebostechnology/posts/Samba-Global/)                                           |
|SMB-003| Legacy               | Samba Share           |  ***Pre-Pub***       |  Nov 9       |   [pre-pub](https://github.com/richard-sebos/articles/blob/main/CUPS-Samba/SMB-003/aritcle.md)                                         |
...
|QUB-003| ProofTrail           | QubesOS Netorks       |  ***Published***       |  Oct 29      |   [The Network in QubesOS](https://richard-sebos.github.io/sebostechnology/posts/Qubes-Network/)                                     |
...
| Type                      | Qty                | Focus                                                   | Platform                |
| ------------------------- | ------------------ | ------------------------------------------------------- | ----------------------- |
| Legacy Article            | 1 / week           | Traditional sysadmin lessons tied to modern containment | dev.to / LinkedIn       |
| Edge / ProofTrail Article | 1 / week           | Architecture, crypto verification, automation           | Blog / dev.to           |
| Breadcrumb Posts          | 2 / week           | 150–250 word insights or commands                       | Mastodon / LinkedIn     |
| Legacy Reposts            | 50 groups / 7 days | Awareness + SEO                                         | Facebook / Linux forums |
...
| ------ | --------------------- | ---------------------------------------------------------------------- | ------------------------------------- |
| **1**  | Strategy setup        | Outline next 4 Legacy + 4 ProofTrail topics, create breadcrumb backlog | Clarity > polish                      |
| **2**  | Legacy #1 draft       | Complete one formatted Legacy post                                     | Easy win – Samba or service isolation |
| **3**  | Edge #1 draft         | “Building Verifiable Trust in Linux”                                   | Conceptual intro                      |
| **4**  | Breadcrumb batch 1    | 2–3 micro-posts from Qubes cheat sheet                                 | 150–250 words                         |
| **5**  | Legacy #2 draft       | Networking/automation piece                                            | Tie to ProofTrail                     |
| **6**  | Edge #2 draft         | “Verifiable Automation with minisign & age”                            | Include live example                  |
| **7**  | Breadcrumb batch 2    | 2 posts on containment + crypto hygiene                                | Short code snippet                    |
| **8**  | Visuals + repost plan | Banners, tags, group list, automation                                  | Buffer/Hootsuite optional             |
| **9**  | QA + cross-linking    | Link legacy ↔ edge ↔ breadcrumb                                        | Cohesive loop                         |
| **10** | Schedule next 3 weeks | Queue across all platforms                                             | You’re 3 weeks ahead                  |

---

## 🗂️ Editorial Matrix (Oct–Dec 2025)

| Code        | Channel             | Topic                     | State       | Publish Date | Title / Link                                          | ProofTrail Phase |
| ----------- | ------------------- | ------------------------- | ----------- | ------------ | ----------------------------------------------------- | ---------------- |
| **SMB-001** | Legacy              | Samba Overview            | ✅ Ready     | Oct 26       | *Secure File Sharing for Mixed Environments*          | –                |
| **SMB-002** | Legacy              | Samba Global Config       | 🧭 Planning | Nov 2        | *Locking Down Samba at the Global Level*              | –                |
| **SMB-003** | Legacy              | Samba Share Security      | 🧭 Planning | Nov 9        | *Per-Share Defense: Granular Samba Security*          | –                |
| **SMB-004** | Legacy              | PAM / MAC / auditd        | 🧭 Planning | Nov 16       | *Stacking Linux Defenses: PAM, MAC & auditd*          | Bridges → AIDE   |
| **ADE-001** | ProofTrail (Bridge) | AIDE Overview             | 🧭 Planning | Nov 16       | *Every File Deserves a Fingerprint – AIDE Edition*    | QCAF 1           |
| **QDE-001** | ProofTrail (Qubes)  | AIDE for Dom0             | 🧾 Pre-Pub  | Nov 16       | *Fingerprinting Dom0: Baselines in a Contained World* | QCAF 1           |
| **QUB-003** | ProofTrail (Qubes)  | QubesOS Networks          | 🧾 Pre-Pub  | Nov 16       | *Securing the Network in QubesOS*                     | QCAF 2           |
| **PRF-002** | ProofTrail          | Signed Evidence Chain     | 🧭 Planning | Nov 23       | *Signed Evidence, Silent Systems*                     | QCAF 2           |
| **PRF-003** | ProofTrail          | Encryption & Verification | 🧭 Planning | Nov 30       | *Encrypt Everything, Verify Twice*                    | QCAF 3           |
| **PRF-004** | ProofTrail          | Vault Archival            | 🧭 Planning | Dec 7        | *Where Proof Sleeps*                                  | QCAF 4           |
| **PRF-005** | ProofTrail          | Short-Lived Qubes         | 🧭 Planning | Dec 14       | *Even Ghosts Leave Fingerprints*                      | QCAF 5           |
| **PRF-006** | ProofTrail          | Alpha Recap               | 🧭 Planning | Dec 21       | *Containment You Can Prove – QCAF v1.0 Preview*       | QCAF 6           |
